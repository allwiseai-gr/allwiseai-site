    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between p-5 md:p-6 border-b border-slate-700 bg-slate-900/95 sticky top-0 z-10 backdrop-blur-md">
          <h2 className="text-lg md:text-xl font-bold text-white">Πολιτική Cookies – Allwise AI</h2>
          <button 
            onClick={onClose}
        ...
        <div className="p-6 overflow-y-auto custom-scrollbar text-slate-300 space-y-6 text-sm leading-relaxed">
          <h3 className="text-xl font-bold text-white mb-4">Πολιτική Cookies – Allwise AI</h3>

          <div className="space-y-4">
            <p>Η Allwise AI χρησιμοποιεί cookies και παρόμοιες τεχνολογίες (π.χ. pixels, tags) για την ορθή λειτουργία του ιστότοπου, τη μέτρηση της απόδοσης και, μόνο με τη συγκατάθεσή σας, για διαφημιστικούς σκοπούς.</p>
            ...
            <p>Η Πολιτική Cookies συμπληρώνει την Πολιτική Απορρήτου της Allwise AI.</p>
            ...
            <div>
              ...
              <p>Για απορίες σχετικά με την παρούσα Πολιτική Cookies μπορείτε να επικοινωνήσετε στο <a href="mailto:info@allwiseai.gr" className="text-[#5227FF] hover:underline">info@allwiseai.gr</a>.</p>
            </div>
          </div>
        </div>
      </div>
