...
const WorkflowNode: React.FC<{ 
  ...
  <div 
    className={`absolute ${className} transform -translate-x-1/2 -translate-y-1/2 bg-slate-900/60 backdrop-blur-md border border-white/10 p-2 md:p-3 rounded-xl shadow-lg z-10 flex items-center justify-center gap-2 md:gap-3 animate-fade-in-up w-[120px] sm:w-[140px] md:w-[150px] pointer-events-none`}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            <p className="text-lg text-slate-300 mb-8 leading-relaxed">
              Φανταστείτε τις εφαρμογές σας να μιλάνε μεταξύ τους. Στην Allwise AI, δεν φτιάχνουμε απλά κώδικα. Χτίζουμε έξυπνες γέφυρες μεταξύ των εργαλείων που ήδη χρησιμοποιείτε.
            </p>
          ...
          <div className="order-1 lg:order-2 relative h-[450px] md:h-[400px] bg-slate-900/60 backdrop-blur-md border border-white/10 rounded-3xl overflow-hidden shadow-2xl w-full pointer-events-none">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 pointer-events-none">
               <div className="relative">
                 ...
                 <div className="bg-slate-900/60 backdrop-blur-md p-3 md:p-5 rounded-2xl shadow-xl border border-[#5227FF]/50 relative z-10 flex flex-col items-center gap-1 md:gap-2 w-[120px] sm:w-[140px]">
