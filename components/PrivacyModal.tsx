    ...
    >
      ...
      >
        ...
        <div className="p-6 overflow-y-auto custom-scrollbar text-slate-300 space-y-6 text-sm leading-relaxed">
          <h3 className="text-xl font-bold text-white mb-4">Πολιτική Απορρήτου – Allwise AI</h3>

          <div className="space-y-4">
            <div>
              <h4 className="font-bold text-white text-base mb-2">1. Ποιοι είμαστε</h4>
              <p>Η Allwise AI είναι agency αυτοματισμών και λύσεων AI για επιχειρήσεις.</p>
              <p>Υπεύθυνος επεξεργασίας των προσωπικών δεδομένων είναι η Allwise AI.</p>
              <p className="mt-2 text-[#5227FF] font-medium">Email επικοινωνίας: info@allwiseai.gr</p>
            </div>
            ...
            <div>
              ...
              <p>Για άσκηση δικαιωμάτων επικοινωνήστε στο <a href="mailto:info@allwiseai.gr" className="text-[#5227FF] hover:underline">info@allwiseai.gr</a>.</p>
            </div>

            <div>
              <h4 className="font-bold text-white text-base mb-2">8. Επικοινωνία</h4>
              <p>Για οποιαδήποτε απορία σχετικά με την παρούσα Πολιτική Απορρήτου μπορείτε να επικοινωνήσετε στο <a href="mailto:info@allwiseai.gr" className="text-[#5227FF] hover:underline">info@allwiseai.gr</a>.</p>
            </div>
          </div>
        </div>
      </div>
